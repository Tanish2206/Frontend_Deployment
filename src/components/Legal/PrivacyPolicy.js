    ...
    <Box m="30px">
	  ...
	  Vijay Nagar, Indore, Madhya Pradesh 452001
        ...
        <ListItem>
          ...
          <Text fontSize="lg">refers to: Madhya Pradesh, India</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg" fontWeight="bold">
            Device
          ...
          <Text fontSize="lg">
            refers to any device that can access the Service such as a computer,
        ...
        <ListItem>
          ...
          <Text fontSize="lg">refers to the Website.</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg" fontWeight="bold">
            Service Provider
      ...
      <UnorderedList mb="4">
        ...
        <ListItem>
          <Text fontSize="lg">First name and last name</Text>
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <Text fontSize="lg">Usage Data</Text>
        </ListItem>
      </UnorderedList>
      {/* The code continues... */}
      {/* Previous code */}
      ...
      <UnorderedList mb="4">
        <ListItem>
          <Text fontSize="lg">To provide and maintain our Service</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg">To notify you about changes to our Service</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg">
        ...
        <ListItem>
          <Text fontSize="lg">To provide customer support</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg">
        ...
        <ListItem>
          <Text fontSize="lg">To monitor the usage of our Service</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg">
      ...
      <UnorderedList mb="4">
        <ListItem>
          <Text fontSize="lg">Comply with a legal obligation</Text>
        </ListItem>
        <ListItem>
          <Text fontSize="lg">
        ...
        <ListItem>
          <Text fontSize="lg">Protect against legal liability</Text>
        </ListItem>
      </UnorderedList>
      {/* The code continues... */}
      ...
      <Text fontSize="lg" mb="4">
        - By email: info@daji.co.in
      </Text>
      <Text fontSize="lg" mb="4">
        - By phone number: +91 6262620801
      </Text>
    </Box>
  );
}
