...
const Terms = () => {
  return (
    <Box m="30px">
      ...
      <Text mt="4" fontSize="4xl" fontWeight="bold" textAlign="center">
        Welcome to DAJI!
      </Text>
      ...
      <Text mt="4">
        ...
        conditions. Do not continue to use DAJI if you do not agree to take all
      ...
      <Heading as="h3" fontSize="xl" fontWeight="bold" mt="4">
      ...
      <Text mt="4">
        Unless otherwise stated, DAJI AND ENGINEERS LLP and/or its licensors own
        the intellectual property rights for all material on DAJI. All
        intellectual property rights are reserved. You may access this from DAJI
        for your own personal use subjected to restrictions set in these terms
        and conditions.
      </Text>

      <Text mt="4">You must not:</Text>

      <UnorderedList mt="4" pl="4">
        <ListItem>Republish material from DAJI</ListItem>
        <ListItem>Sell, rent or sub-license material from DAJI</ListItem>
        <ListItem>Reproduce, duplicate or copy material from DAJI</ListItem>
        <ListItem>Redistribute content from DAJI</ListItem>
      </UnorderedList>

      <Text mt="4">This Agreement shall begin on the date hereof.</Text>

      <Text mt="4">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. DAJI
        ...
        of DAJI, its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, DAJI shall not be liable for the Comments
      ...
      <Text mt="4">
        DAJI reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </Text>

      <Text mt="4">You warrant and represent that:</Text>
      ...
      <Text mt="4">
        You hereby grant DAJI a non-exclusive license to use, reproduce, edit
      ...
      <Text mt="4">
        ...
        the hyperlink compensates the absence of DAJI; and (d) the link is in
      ...
      <Text mt="4">
        ...
        e-mail to DAJI. Please include your name, your organization name,
